    ...
    <main className="min-h-screen bg-[#F4EFE4]">
      ...
      <section id="experiences" className="bg-[#F4EFE4] pt-20 pb-24">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <h2 className="text-[clamp(36px,5vw,52px)] font-light text-[#2C2416] leading-tight mb-8">
            {experiences.heading}
          </h2>

          <p className="text-[16px] font-light text-[#8C7B6B] leading-relaxed max-w-3xl mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
            {experiences.workshops.map((exp) => (
              <div key={exp.name} className="bg-[#EDE5D8] rounded-lg p-8 flex flex-col">
                <h3 className="text-[18px] font-light text-[#2C2416] mb-3">
                  {exp.name}
                </h3>
                <p className="text-[15px] font-light text-[#8C7B6B] leading-relaxed flex-grow">
                  {exp.desc}
                </p>
              </div>
            ))}
