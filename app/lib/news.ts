...
export const newsArticles: NewsArticle[] = [
  {
    ...
    title: 'Seri Gopan（せりごぱん）ポップアップ開催決定！',
    title_en: 'Seri Gopan Pop-Up — It\'s Happening!',
    body: [
      'Felicityにて、葉山発のグルテンフリーベーカリー「Seri Gopan（せりごぱん）」のポップアップ開催が決定しました！第一弾は7月8日（水）・7月22日（水）の2日間です。',
      '2023年、葉山の地で生まれたSeri Gopan。「BAKED BY SERI」の名のとおり、店主・せりさんが一つひとつ心を込めて焼き上げる、グルテンフリーのパンです。小麦粉を使わず米粉などを生かすことで、からだにやさしく、毎日でも気持ちよく食べられる味わいを大切にしています。',
      ...
      'これからの暑い季節は焼き物にとって難しい時期ではありますが、告知を重ねながら少しずつ盛り上げていけたらと思っています。最新情報は出店者「せりごぱん」（Instagram @seri_gopan）でもご案内します。',
    ],
    body_en: [
      ...
      'Founded in Hayama in 2023 and true to its "Baked by Seri" name, Seri Gopan is a labor of love — every gluten-free loaf is shaped and baked by hand, one at a time, by its baker, Seri. By working with rice flour rather than wheat, she creates bakes that are gentle on the body and easy to enjoy every day.',
