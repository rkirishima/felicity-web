...
export default function HomePageEN() {
  ...
  return (
    <main className="min-h-screen bg-[#F4EFE4]">
      {/* ── Header ──────────────────────────────────────────────────────── */}
      <Header locale="en" pathname="/en/" contactLabel={homepage.nav.contact} />
      ...
      <section id="philosophy" className="bg-[#F4EFE4] pt-20 pb-24">
        <div className="max-w-3xl mx-auto px-8">
          ...
          <h2 className="text-[clamp(28px,4vw,40px)] font-light text-[#2C2416] leading-tight mb-12">
