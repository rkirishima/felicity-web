      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <a href="mailto:info@felicity.cafe" className="text-[12px] text-[#8C7B6B] hover:text-[#2C2416] transition-colors">
              info@felicity.cafe
            </a>
          </div>
          ...
          <div>
            ...
            <a
              ...
              className="text-[12px] text-[#8C7B6B] hover:text-[#2C2416] transition-colors"
            >
              Instagram
            </a>
          </div>
